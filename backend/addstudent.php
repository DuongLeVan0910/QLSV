...
// Ghi log để debug dữ liệu nhận được (có thể xóa dòng này sau khi test xong)
...
$checkStmt = $conn->prepare("SELECT id FROM studentss WHERE mssv = ?");
...
$stmt = $conn->prepare("INSERT INTO studentss (mssv, hoten, khoa, lop, ngaysinh) VALUES (?, ?, ?, ?, ?)");
